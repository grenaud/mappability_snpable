...
bwa aln -t 35 -R 1000000 -O 3 -E 3 $REFGENOME  <($DIRSEQBILITY/splitfa $REFGENOME 35 ) |bwa samse $REFGENOME /dev/stdin <($DIRSEQBILITY/splitfa $REFGENOME 35 ) | $DIRSEQBILITY/gen_raw_mask.pl |gzip > rawMask_35.fa.gz
